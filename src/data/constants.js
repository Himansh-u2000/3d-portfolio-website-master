...
export const projects = [
  {
    ...
    description:
      "End-to-end crop recommendation platform that considers soil data, weather conditions, and market prices using KNN. Features web (React) and mobile (Flutter) interfaces, and uses real-time APIs for decision making.",
  ...
  },
  {
    ...
    description:
      "ML model that predicts track popularity using Spotify metadata such as tempo, danceability, etc. Presented at an international research conference organized by Quantum University.",
    image: "https://ik.imagekit.io/iyyolel10/portfolio-projects-thumbnail/hip-hop-thumbnail.png?updatedAt=1748631112023",
    tags: ["Python", "ML", "Scikit-learn", "Spotify API", "Data Science"],
    category: "machine learning",
    github: "https://github.com/Himansh-u2000/AI",
  },
  {
    id: 4,
    title: "Psychological Patient Tracker App",
    date: "Feb 2024",
    description:
      "Kotlin-based Android app to schedule and manage psychological sessions. Includes CameraX-based image logging, note tracking, appointment scheduling, and Gemini API integration for task reminders and insights.",
    image: "https://developer.android.com/static/images/android-logo.svg", // Replace with actual image if needed
    tags: ["Kotlin", "CameraX", "Room DB", "Gemini API", "MVVM"],
  ...
  },
  {
    ...
    date: "Jul 2024",
    description:
      "Mobile app built in Flutter to receive real-time alerts when nearby accidents are detected by a hardware device. Uses WebSocket and Google Maps API for emergency response.",
  ...
  },
  {
    ...
    date: "Dec 2023",
    description:
      "Android app displaying real-time weather data using a third-party API. Built using Jetpack Compose for modern UI and Kotlin for logic handling.",
  ...
  },
  {
    ...
    date: "Nov 2023",
    description:
      "Simple Android notes application with Room Database for persistent storage, note editing, and deletion. Built using MVVM architecture.",
  ...
  },
  {
    ...
    date: "May 2025",
    description:
      "Python-based utility to convert photos into pencil sketches using OpenCV and image processing filters. Command-line and GUI versions supported.",
